...
function install_verrazzano()
{
  ...
  helm \
      ...
      --set verrazzanoOperator.cohMicroImage="phx.ocir.io/stevengreenberginc/verrazzano/verrazzano-coh-cluster-operator-jenkins:1acdee76f5457db9957ba051c5c2d51886aab1bf"
