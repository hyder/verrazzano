...
CERT_MANAGER_IMAGE=phx.ocir.io/stevengreenberginc/verrazzano/cert-manager-controller
CERT_MANAGER_TAG=0.13.1-0e7394e-18
CERT_MANAGER_RELEASE=0.13
CERT_MANAGER_HELM_CHART_VERSION=0.13.1
CERT_MANAGER_SOLVER_IMAGE=phx.ocir.io/stevengreenberginc/verrazzano/cert-manager-acmesolver
...
EXTERNAL_DNS_REGISTRY=phx.ocir.io/stevengreenberginc
...
KEYCLOAK_IMAGE=phx.ocir.io/stevengreenberginc/verrazzano/keycloak
KEYCLOAK_IMAGE_TAG=10.0.1-30d98b0-5
KEYCLOAK_CHART_VERSION=8.2.2

KEYCLOAK_THEME_IMAGE=phx.ocir.io/stevengreenberginc/verrazzano/keycloak-oracle-theme:v0.0.1

MYSQL_IMAGE_TAG=8.0.20

NGINX_INGRESS_CONTROLLER_IMAGE=phx.ocir.io/stevengreenberginc/verrazzano/nginx-ingress-controller
NGINX_INGRESS_CONTROLLER_TAG=0.32-aadecdc-21
NGINX_INGRESS_CONTROLLER_VERSION=1.27.0

NGINX_DEFAULT_BACKEND_IMAGE=phx.ocir.io/stevengreenberginc/verrazzano/nginx-ingress-default-backend
NGINX_DEFAULT_BACKEND_TAG=0.32-aadecdc-21

RANCHER_IMAGE=phx.ocir.io/stevengreenberginc/verrazzano/rancher
